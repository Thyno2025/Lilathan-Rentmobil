...
<div class="fl-col-group fl-node-waypolx635v4 fl-col-group-equal-height fl-col-group-align-center" data-node="waypolx635v4">
			<div class="fl-col fl-node-jbnoy1z3wlid fl-col-bg-color fl-col-small" data-node="jbnoy1z3wlid">
	<div class="fl-col-content fl-node-content"><div class="fl-module fl-module-rich-text fl-node-0b35urzgcntm" data-node="0b35urzgcntm">
	<div class="fl-module-content fl-node-content">
		<div class="fl-rich-text">
	<p style="text-align: center;"><span style="font-size: 26px; color: #b70024;"><strong>Selamat Datang di Website</strong></span><br>
<span style="font-size: 16px;"><strong>www.LilathanRentmobil.com</strong></span></p>
</div>
...
<span class="price_info"><?php echo htmlentities(format_rupiah($results['harga']));?> /Hari</span> 
<p><?php echo substr($results['deskripsi'],0,70);?></p>

<a class="btn btn-xs uppercase" href="https://wa.me/6287874476301"><i class="fa fa-whatsapp fa-2x text-success d-inline-block align-middle mr-2" aria-hidden="true"></i> Rental Sekarang</a>
</div>
</div>
</div>
<?php }}?>
